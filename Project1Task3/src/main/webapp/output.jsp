<%-- 
    ...
    Displays the result the user has selected and prompts user to select another option.
--%>
...
<html>
    ...
    <body>
        ...
        Your response "<%=request.getAttribute("answer")%>" has been registered<br><br>
